...
private static void da() {
		...
		stavka1.dodajProizvod(proizvod1);
		stavka2.dodajProizvod(proizvod2);
		stavka3.dodajProizvod(proizvod3);
		stavka4.dodajProizvod(proizvod4);
		stavka5.dodajProizvod(proizvod5);
		stavka6.dodajProizvod(proizvod6);
		stavka7.dodajProizvod(proizvod7);
		stavka8.dodajProizvod(proizvod8);
		stavka9.dodajProizvod(proizvod9);
		stavka10.dodajProizvod(proizvod10);
