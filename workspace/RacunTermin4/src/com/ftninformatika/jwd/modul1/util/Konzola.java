package com.ftninformatika.jwd.modul1.util;
...
/**
 * Klasa koja nudi funkcije za zaštićenu interakciju, oslanjajući se na ispis
 * putem {@code System.out} standardnog <i>stream</i>-a i unos putem
...
public class Konzola {
	...
	/**
	 * Zahteva od korisnika unos {@code String}-a, prikazujući mu usput obaveštenje.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	 * @return Uneseni {@code String}
	 *
	 * @throws IllegalArgumentException Ako je {@code poruka} {@code null} ili je
	 *                                  prazna
	...
	/**
	 * Zahteva od korisnika unos {@code char}-a koji nije prazan, prikazujući mu
	 * usput obaveštenje. Unos se ponavlja dok se ne unese {@code char} koji nije
	 * prazan.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	...
	/**
	 * Zahteva od korisnika unos {@code boolean}-a prikazujući mu usput obaveštenje.
	 * Unos se ponavlja dok se ne unese validna {@code boolean} vrednost.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	...
	/**
	 * Zahteva od korisnika unos {@code long}-a prikazujući mu usput obaveštenje.
	 * Unos se ponavlja dok se ne unese validna {@code long} vrednost.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	...
	/**
	 * Zahteva od korisnika unos {@code float}-a prikazujući mu usput obaveštenje.
	 * Unos se ponavlja dok se ne unese validna {@code float} vrednost.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	...
	/**
	 * Zahteva od korisnika unos {@code double}-a prikazujući mu usput obaveštenje.
	 * Unos se ponavlja dok se ne unese validna {@code double} vrednost.
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	 ...
	 * obaveštenje. Unos se ponavlja dok se ne unese validna {@code LocalDateTime}
	 * vrednost po formatu "dd.MM.yyyy. HH:mm".
	 *
	 * @param poruka Poruka koja obaveštava korisnika o tome šta treba da unese
	...
	/**
	 * Zahteva od korisnika unos {@code String}-a koji mora biti jednak jednom od 2
	 * ponuđena {@code String}-a rezervisanih za potvrdan ili odričan odgovor na
	 * pitanje. Unos se ponavlja sve dok se ne unese jedan od ponuÄ‘enih
	 * {@code String}-ova.
	 *
	 ...
	 *
	 * @throws IllegalArgumentException Ako su {@code pitanje}, {@code da} ili
	 *                                  {@code ne} {@code null} ili prazni
	 * 
	 */
	public static boolean ocitajIzbor(String pitanje, String da, String ne)
	...
	/**
	 * Zahteva od korisnika unos {@code String}-a koji mora biti jednak "d" ili "n"
	 * za potvrdan, odnosno odričan odgovor. Unos se ponavlja sve dok se ne unese
	 * jedan od ponuÄ‘enih {@code String}-ova.
	 *
	 * @param pitanje Pitanje koje se prikazuje korisniku
	 * @return odgovor korisnika u vidu {@code boolean} vrednosti
	 *
	 * @throws IllegalArgumentException Ako je {@code pitanje} {@code null} ili je
	 *                                  prazno
	 * 
	 */
	 ...
	 * @return Formatiranu {@code String} reprezentaciju ulaznog parametra
	 *
	 * @throws DateTimeException Ako {@code datumIVreme} ne može da se formatira
	 * 
	 */
